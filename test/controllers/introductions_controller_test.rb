...
class IntroductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create introduction" do
    assert_difference('Introduction.count') do
      post introductions_url, params: { introduction: { name: @introduction.name, profile: @introduction.profile } }
    end
  ...
  test "should update introduction" do
    patch introduction_url(@introduction), params: { introduction: { name: @introduction.name, profile: @introduction.profile } }
